...
binedges=[0,50,100,150,400,700]
binedges2=[0,10,20,40,80,150,200,400]
plots=[
    ...
    Plot(ROOT.TH1F("pt1","p_{T} of leading jet",700,0,700),"Jet_Pt[0]",plotselection,plotlabel,binedges),
    Plot(ROOT.TH1F("pt2","p_{T} of second jet",400,0,400),"Jet_Pt[1]",plotselection,plotlabel,binedges2),
...
plots.append(variableBinning(plots[0],binedges))
